                ...
                child: Row(
                  children: [
                    ...
                    SizedBox(
                        ...
                        child: (branchState is LocationLoadedState)
                            ? FutureBuilder<String>(
                                future: myLocation(branchState.userLocation),
                  ...
                  child: BlocBuilder<BaberBloc, BaberState>(
                    builder: (context, state) {
                      if (state is LoadingState) {
                              ...
                              return Container(
                                ...
                                child: Padding(
                                  ...
                                  child: TopSpecialistWidget(
                                    ...
                                    minCost: minPrice,
                                    distance:
                                        (branchState is LocationLoadedState)
                                            ? getDistanceBetweenCoordinates(
                                                branchState.userLocation,
                        ...
                        //returning all the babers if no filter has being selected
                        return ListView.builder(
                          scrollDirection: Axis.horizontal,
                          physics: const ClampingScrollPhysics(),
                          shrinkWrap: true,
                          ...
                          itemBuilder: (context, index) {
                            ...
                            List<double> prices =
                                baber.services.values.toList();
                            //finding the minimum value in the list
                            double minPrice = prices.reduce((value, element) =>
                                value < element ? value : element);
                            return Container(
                              margin: const EdgeInsets.only(left: 15),
                              child: Padding(
                                ...
                                child: TopSpecialistWidget(
                                  baber: baber,
                                  minCost: minPrice,
                                  distance: (branchState is LocationLoadedState)
                                      ? getDistanceBetweenCoordinates(
                                          branchState.userLocation,
                                          branchState.destination)
                                      : 0,
